...
Most of these come down to network reality or how colorapi serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

colorapi rate-limits like any public site. colorapi already paces
...
Where a surface is gated, colorapi reads a cookie or token you supply
...
`colorapi`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what colorapi actually did
