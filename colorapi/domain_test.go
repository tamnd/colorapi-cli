...
// HTTP behaviour is covered in colorapi_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "colorapi://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("colorapi", "about")
	if err != nil || got.String() != "colorapi://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want colorapi://page/about", got.String(), err)
	}
}
